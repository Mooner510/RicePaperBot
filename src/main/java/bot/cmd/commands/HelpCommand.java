...
public class HelpCommand implements BotCommand {
    ...
    public void onCommand(SlashCommandInteractionEvent event) {
        ...
        builder.setTitle("명령어").setDescription("< > = 필수 입력란, [ ] = 선택 입력란")
                ...
                .addField("/setnotify channel <켜기|끄기>", "개인 DM으로 알림을 받을지 설정해요.\n\n조식, 중식, 석식을 일정 시간마다 알려드려요.\n구지 `/rice`명령어를 쓰지 않아도 알려드린다구요!", false)
                .addField("/setnotify guild [채널] [학교]", "서버에 특정 채널에서 알림을 받을지 설정해요.\n\n개인 알림과 같이 조식, 중식, 석식을 일정 시간마다 알려드려요.\n[채널]과 [학교]란에 아무것도 입력하지 않으면 알림을 끌 수 있습니다.", false)
                .addField("/changes", "마지막 업데이트 변경 사항을 확인해요.\n\n무엇이 추가되었고 바뀌었는지 확인할 수 있어요.\n자세한 내용은 Github를 참고해주세요!", false)
